        ...
        <div class="d-flex">
            <div class="col-10 pl-0 d-flex">
                <div class="d-flex align-items-center">
                    ...
                    <a class="conversation-header-username small text-muted conversation-profile-link" target="_blank">{{--Contact username placeholder--}}</a>
                    </div>

                </div>

            </div>
            <div class="col-2 pr-0 d-flex justify-content-end align-items-center">
                <div class="d-flex align-items-center">
                    <div class="dropdown {{GenericHelper::getSiteDirection() == 'rtl' ? 'dropright' : 'dropleft'}}">
                        <a class="btn btn-sm btn-outline-primary dropdown-toggle px-2 py-1 mb-0" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
