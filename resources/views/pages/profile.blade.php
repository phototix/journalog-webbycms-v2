...
">
            ...
            <div class="container pt-2 pl-0 pr-0">
                ...
                @if(getSetting('stories.allow_highlights'))
                    <div class="profile-highlights d-none mb-3" id="profile-highlights">
                        ...
                        <div class="swiper profile-highlights-swiper px-4">
                            {{-- Skeleton (re-use feed skeleton) --}}
                            <div class="profile-highlights-skeleton">
                                @include('elements.preloading.stories-swiper-skeleton', ['limit' => 3])
                            </div>
    ...
    @if(Auth::check())
        ...
        @include('elements.gifts.gift-modal')
        @include('elements.gifts.gift-effect')
