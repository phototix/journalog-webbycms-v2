...
class ProfileController extends Controller
{
    ...
    protected function setAccessRules()
    {
        ...
        // Free profiles are fully accessible to everyone without follow/subscription
        if (!$this->user->paid_profile) {
            $this->hasSub = true;
            $this->viewerHasChatAccess = true;
        }

        if ($viewerUser) {
            $this->hasSub = $this->hasSub || PostsHelperServiceProvider::hasActiveSub($viewerUser->id, $this->user->id);
